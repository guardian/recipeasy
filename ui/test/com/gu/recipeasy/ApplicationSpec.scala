...
class recipeConversion extends FlatSpec with Matchers {
  "A raw recipe" should "be converted to a detailed recipe" in {
    ...
    val bread = new DetailedIngredient(None, None, None, None, "", None, "bread")
    val toaster = new DetailedIngredient(None, None, None, None, "", None, "toaster")
    val oats = new DetailedIngredient(None, None, None, None, "", None, "cup of oats")
    val milk = new DetailedIngredient(None, None, None, None, "", None, "glug of milk")
    val banana = new DetailedIngredient(None, None, None, None, "", None, "banana")
